...
describe('itemController', () => {
  ...
  describe('getById', () => {
    ...
    it('should return 404 when non-numeric ID is provided', () => {
      req.params.id = 'abc';
    ...
    it('should return 404 when zero ID is provided', () => {
      req.params.id = '0';
  ...
  describe('updateItem', () => {
    ...
    // Test: Should update with empty string name
  ...
  describe('deleteItem', () => {
    ...
    // Test: Should delete correct item from array
    it('should delete correct item from array', () => {
      const items = require('../data/items');
      req.params.id = '1';
