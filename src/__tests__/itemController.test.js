...
describe('itemController', () => {
  ...
  describe('getById', () => {
    ...
    // Test: Should handle string ID parameter
    ...
    // Test: Should handle invalid ID parameter
  ...
  describe('updateItem', () => {
    ...
    // Test: Should preserve existing name when no new name provided
    it('should preserve existing name when no new name provided', () => {
      req.params.id = '1';
      req.body = {};
    ...
    // Test: Should handle falsy name value
    it('should preserve existing name when falsy name provided', () => {
      req.params.id = '1';
      req.body.name = '';
