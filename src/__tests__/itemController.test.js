...
describe('itemController', () => {
  ...
  describe('createItem', () => {
    ...
    // Test: Should create item even with empty name
    it('should create item even when name is undefined', () => {
      req.body = {};
    ...
    // Test: Should increment id correctly when items array grows
    it('should assign correct id based on current array length', () => {
      const items = require('../data/items');
  ...
  describe('deleteItem', () => {
    ...
    it('should actually remove item from the items array', () => {
      const items = require('../data/items');
